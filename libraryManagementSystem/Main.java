...
public class Main {
    public static void main(String[] args) {
        ...
        LibraryPersonnel libraryPersonnel = new LibraryPersonnel("Tuğba", "müdür");
        ...
        librarySystem.addLibraryPersonnel(libraryPersonnel);
        librarySystem.listLibraryPersonnel();
